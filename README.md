[<img width="75px" style="display:inline-block" src="frontend/public/gg-favicon.png">](frontend/public/gg-favicon.png) <h1 style="line-height:80px, display:inline-block">Goal Garden</h1>
